...
SCRIPT = (
  ...
  / "scripts/workcell/convert_usb_0914_200.py"
)
SPEC = importlib.util.spec_from_file_location("usb_0914_200_launcher", SCRIPT)
...
def test_layout_accepts_only_distinct_format_directories(tmp_path):
  raw = tmp_path / "usb_insert/raw/0914_200"
  pi05 = tmp_path / "usb_insert/pi05/0914_200"
  egosteer = tmp_path / "usb_insert/egosteer/0914_200"
...
def test_preflight_rejects_existing_selected_output(monkeypatch, tmp_path):
  ...
  python.touch()
  converter.touch()
  output = tmp_path / "usb_insert/pi05/0914_200"
