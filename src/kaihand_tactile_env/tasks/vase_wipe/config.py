...
FLOOR_HEIGHT = 0.100
WALL_COUNT = 24
STAIN_HEIGHTS = (0.178, 0.187, 0.196)
...
STAIN_ANGLE_RAD = 0.0
STAIN_ANGLE_SPACING_RAD = 0.045
STAIN_COLOR = (0.82, 0.025, 0.035, 1.0)
...
# Complete lateral cycles (2.8 s each); residual sweeps get one extra cycle.
WIPE_SECONDS = 8.4
RESIDUAL_WIPE_SECONDS = 11.2
MAX_WIPE_PASSES = 6
...
PATCH_WORK_REQUIRED_J = 0.0006
PATCH_STROKE_REQUIRED_M = 0.012
PATCH_DWELL_REQUIRED_S = 0.40
MAX_MEAN_DIRT = 0.05
MAX_PATCH_DIRT = 0.10
...
SPONGE_CONTACT_MARGIN_M = 0.0015
