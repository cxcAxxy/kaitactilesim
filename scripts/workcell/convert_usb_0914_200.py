#!/usr/bin/env python3
"""Launch the 0914_200 USB conversions with a shared adaptive CPU budget.
...
DATASET_ROOT = Path("/nas/chenxianchi/datasets/sim/usb_insert")
...
DEFAULT_SCRATCH_ROOT = Path(
  "/cpfs_infra/user/chenxianchi/.conversion_staging/usb_0914_200"
)

SIM_PYTHON = SIM_ROOT / ".venv/bin/python"
OPENPI_PYTHON = OPENPI_ROOT / ".venv-pi05/bin/python"
PI05_CONVERTER = OPENPI_ROOT / "examples/kaihand/convert_usb_to_lerobot.py"
EGOSTEER_CONVERTER = SIM_ROOT / "scripts/workcell/convert_usb_to_egosteer.py"
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
  ...
  parser.add_argument(
    ...
    help=(
      ...
      "adds a full 64.7 GiB source read per selected converter."
    ),
  )
  parser.add_argument(
    "--limit",
